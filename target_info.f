...
C (nucl-th/9812078)
	...
	real*8		lookup(11,10)/			!data vs. Z.

!  From Nadia's iteration: August 2007
!-------------------------------------------------------------------------------
!        H     2H       3H    3He     4He      Be      C       Al     Fe     Cu       Au
!-------------------------------------------------------------------------------
!
     > 1., 1., 1., 2., 2., 4.,  6., 13., 26., 29.,  79., !Z's
     > 1., 2., 3., 3., 4., 9., 12., 27., 56., 64.,  197., !A's
     > 61.28,122.6,71.07,71.07,94.32,65.19,42.7,24.01,13.84,12.86,6.461, !R.L.s in g/cm^2 (not used)
     > 0.00,0.14,0.10,0.10,0.16,0.10,0.25,0.25,0.25,0.10,0.25, !RESOL's
     > 0.00,0.00225,0.00549,0.00549,0.02020,0.00928,0.01727,0.0099, 
     >                                  0.01060,0.00855,    0.00693, !E_SEP's in GeV.
     > 0.0056000,0.00904157,0.0053094,0.0053094,0.0040197,0.0034814,
     >            0.0031822,0.0032783,0.0028900,0.00287403,0.0026424,    !f0
     > 0.0000000,0.000852159,0.0021843,0.0021843,0.0013449,0.0011608,
     >             0.0013591,0.0013474,0.0014016,0.0008866,0.0007632,    !bigB
     > 0.0000000,  0.0077272,0.0028864,0.0028864,0.0026986,0.0031195,
     >             0.0030265,0.0029698,0.0031802,0.0030959,0.0030654,    !a
     > 0.0000000, 0.0093937, 0.0103492,0.0103492,0.0074941,0.0078398,
     >             0.0070505,0.0065760,0.0072635,0.0070945,0.0067678,    !b
     > 20.000,45.384,64.247,64.247,100.256,110.967,137.285,131.845,
     >                                  165.700,   132.458,   132.452/   !alpha
